...
import 'zrole_club_profile_model.dart';
export 'zrole_club_profile_model.dart';
...
///
///
class ZroleClubProfileWidget extends StatefulWidget {
  const ZroleClubProfileWidget({super.key});

  static String routeName = 'zroleClubProfile';
  static String routePath = '/zroleClubProfile';

  @override
  State<ZroleClubProfileWidget> createState() => _ZroleClubProfileWidgetState();
}

class _ZroleClubProfileWidgetState extends State<ZroleClubProfileWidget>
    with TickerProviderStateMixin {
  late ZroleClubProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZroleClubProfileModel());
