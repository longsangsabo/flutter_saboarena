...
import 'cardprofile_model.dart';
export 'cardprofile_model.dart';
...
class _CardprofileWidgetState extends State<CardprofileWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardprofileModel());
  }
