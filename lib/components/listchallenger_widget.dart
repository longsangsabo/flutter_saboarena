...
import 'listchallenger_model.dart';
export 'listchallenger_model.dart';

/// New Component Gen
class ListchallengerWidget extends StatefulWidget {
  const ListchallengerWidget({
    super.key,
  ...
  @override
  State<ListchallengerWidget> createState() => _ListchallengerWidgetState();
}

class _ListchallengerWidgetState extends State<ListchallengerWidget> {
  late ListchallengerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListchallengerModel());
  }
